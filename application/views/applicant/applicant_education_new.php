<div class="ibox">
    <div class="ibox-heading">
        <div class="ibox-title">
            ...
            <?php
            $current_category=$APPLICANT->entry_category;
    ...
    <div class="ibox-content">
        ...
        if (isset($action)) {
            ...
            <?php if($current_category==20) { ?>
<br>
            <div style=" color: brown; font-weight: bold; border-bottom: 1px solid blue; margin-bottom: 10px; margin-left: 20px">
                Certificate
            </div>
            <div class="form-group"><label class="col-lg-3 control-label">Certificate : <span
                            class="required">*</span></label>
                <div class="col-lg-8">
                    <select name="certificate" id="o_certificate" class="form-control"  >
                        <?php

                        $sel = set_value('certificate', (isset($education_info) ? $education_info->certificate : ''));
                        foreach ($certificate_list as $key => $value) {
                            ?>
                            <option <?php echo($key == 1 ? 'selected="selected"' : ''); ?>
            ...
            <div class="form-group"><label class="col-lg-3 control-label"> Index Number : <span
                            class="required">*</span></label>
                <div class="col-lg-8">
                    <input type="text"
                           value="<?php echo set_value('index_number', (isset($education_info) ? $education_info->index_number : '')); ?>"
                           class="form-control" name="index_number" id="o_index_number" onblur="loadAjaxData(this.value,'','','o-level')">
            ...
            <div class="form-group"><label class="col-lg-3 control-label">Examination Authority : <span
                ...
                <div class="col-lg-8">
                    ...
                    <input type="text"
                           value="NECTA"
                           class="form-control" name="exam_authority" id="o_exam_authority" readonly >
            ...
            <div class="form-group"><label class="col-lg-3 control-label">Division/Grade : <span
                ...
                <div class="col-lg-8">
                    <input type="text"
                           ...
                           class="form-control" name="division" id="o_division">
            ...
            <div class="form-group"><label class="col-lg-3 control-label">Centre/School : <span
                ...
                <div class="col-lg-8">
                    <input type="text"
                           ...
                           class="form-control" name="school" id="o_school">
            ...
            <div class="form-group"><label class="col-lg-3 control-label">Year Completed : <span
                ...
                <div class="col-lg-8">
                    <input type="text"
                           ...
                           class="form-control" name="completed_year" id="o_completed_year">
            ...
            <div class="form-group"><label class="col-lg-3 control-label">Certificate : <span
                            class="required">*</span></label>
                <div class="col-lg-8">
                    <select name="certificate" id="certificate" class="form-control" onchange="loadAjaxData(this.value,'exam_authority1','exam_authority')">
                ...
                <div class="form-group"><label class="col-lg-3 control-label">Examination Authority : <span
                    ...
                    <div class="col-lg-8">
                        ...
                        <input type="text"
                               ...
                               class="form-control" name="exam_authority1" id="exam_authority1" placeholder="Eg: NECTA">
                ...
                <div class="form-group"><label class="col-lg-3 control-label">Examination Authority : <span
                    ...
                    <div class="col-lg-8">
                        <input type="text"
                               ...
                               class="form-control" name="exam_authority" id="exam_authority" placeholder="Eg: NACTE">
                        <?php echo form_error('exam_authority'); ?>
                    </div>
                </div>
...
<script>
    ...
    function loadAjaxData(value,target_field,get_focused_field,action) {
        ...
        $.ajax({
            type:"post",
            url:"<?php echo site_url('loadAjaxData') ?>",
            data: {
                target:target_field,
                id:value,
            ...
            success:function(data)
            {
                if(action=='o-level')
                {
                    ...
                    $("#o_division").val(my_data_array[0]);
                    $("#o_school").val(my_data_array[1]);
                    $("#o_completed_year").val(my_data_array[2]);

                }
                else if(target_field=='exam_authority1')
                {
                    loadAjaxData(this.value,'exam_authority','exam_authority')
                    $( "#" + target_field).val(data);
