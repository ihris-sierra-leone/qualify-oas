            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content no-padding">
                    <ul class="folder-list m-b-md" style="padding: 0">
                        ...
                        ?>
                            <li style="padding: 5px 20px; font-size: 15px;"><a href="<?php echo ( ($basic and $APPLICANT->submitted!=1)? site_url('applicant_contact/'.($contact ? encode_id($contact):'')):'javascript:void(0);') ?>"> <i class="fa fa-star "></i> Contact Information <span class="label label-warning pull-right"><i class="fa <?php echo  ($contact ? 'fa-check':'fa-times'); ?> no-margins"></i></span> </a></li>
                        <li style="padding: 5px 20px; font-size: 15px;"><a href="<?php echo ( ($contact and  $APPLICANT->submitted!=1) ? site_url('applicant_activate/'.($activate_account ? encode_id($activate_account):'')):'javascript:void(0);') ?>"> <i class="fa fa-star "></i> Activate Account <span class="label label-warning pull-right"><i class="fa <?php echo  ($activate_account ? 'fa-check':'fa-times'); ?> no-margins"></i></span> </a></li>
                        <?php if($activate_account){ ?>
                            <li style="padding: 5px 20px; font-size: 15px;"><a href="<?php echo (($activate_account and  $APPLICANT->submitted!=1) ? site_url('applicant_payment/'.($payment ? encode_id($payment):'')):'javascript:void(0);') ?>"> <i class="fa fa-star "></i> Application Fee Payment <span class="label label-warning pull-right"><i class="fa <?php echo  ($payment ? 'fa-check':'fa-times'); ?> no-margins"></i></span> </a></li>
                            <?php if($payment) { ?>
                                <li style="padding: 5px 20px; font-size: 15px;"><a href="<?php echo ( ($payment and   $APPLICANT->submitted!=1) ? site_url('applicant_profile/'.($photo ? encode_id($photo):'')):'javascript:void(0);') ?>"> <i class="fa fa-star "></i> Profile Picture <span class="label label-warning pull-right"><i class="fa <?php echo  ($photo ? 'fa-check':'fa-times'); ?> no-margins"></i></span> </a></li>
                                <li style="padding: 5px 20px; font-size: 15px;"><a href="<?php echo ( ($payment and  $APPLICANT->submitted!=1) ? site_url('applicant_next_kin/'.($nextkin ? encode_id($nextkin):'')):'javascript:void(0);') ?>"> <i class="fa fa-star "></i> Next of Kin Particulars <span class="label label-warning pull-right"><i class="fa <?php echo  ($nextkin ? 'fa-check':'fa-times'); ?> no-margins"></i></span> </a></li>
                            <li style="padding: 5px 20px; font-size: 15px;"><a href="<?php echo ( ($payment  and  $APPLICANT->submitted!=1)   ? site_url('applicant_education/'.($education ? encode_id($education):'')):'javascript:void(0);') ?>"> <i class="fa fa-star "></i> Education Background <span class="label label-warning pull-right"><i class="fa <?php echo  ($education ? 'fa-check':'fa-times'); ?> no-margins"></i></span> </a></li>
                            <li style="padding: 5px 20px; font-size: 15px;"><a href="<?php echo ( ($payment and   $APPLICANT->submitted!=1) ? site_url('applicant_attachment/'.($attachment ? encode_id($attachment):'')):'javascript:void(0);') ?>"> <i class="fa fa-star "></i> Attachment <span class="label label-warning pull-right"><i class="fa <?php echo  ($attachment ? 'fa-check':'fa-times'); ?> no-margins"></i></span> </a></li>
                            <li style="padding: 5px 20px; font-size: 15px;"><a href="<?php echo ( ($payment and   $APPLICANT->submitted!=1) ? site_url('applicant_choose_programme/'.($programme ? encode_id($programme):'')):'javascript:void(0);') ?>"> <i class="fa fa-star "></i> Choose Programme <span class="label label-warning pull-right"><i class="fa <?php echo  ($programme ? 'fa-check':'fa-times'); ?> no-margins"></i></span> </a></li>
                            <?php
                            if($APPLICANT->application_type == 3){
                                ?>
                                <li style="padding: 5px 20px; font-size: 15px;"><a href="<?php echo ( ($programme and  $APPLICANT->submitted!=1) ? site_url('applicant_experience/'.($experience ? encode_id($experience):'')):'javascript:void(0);') ?>"> <i class="fa fa-star "></i> Professional  Experience <span class="label label-warning pull-right"><i class="fa <?php echo  ($experience ? 'fa-check':'fa-times'); ?> no-margins"></i></span> </a></li>
                                <li style="padding: 5px 20px; font-size: 15px;"><a href="<?php echo ( ($experience and  $APPLICANT->submitted!=1) ? site_url('applicant_referee/'.($referee ? encode_id($referee):'')):'javascript:void(0);') ?>"> <i class="fa fa-star "></i> Academic Referee <span class="label label-warning pull-right"><i class="fa <?php echo  ($referee ? 'fa-check':'fa-times'); ?> no-margins"></i></span> </a></li>
                                <li style="padding: 5px 20px; font-size: 15px;"><a href="<?php echo ( ($referee and  $APPLICANT->submitted!=1) ? site_url('applicant_sponsor/'.($sponsor ? encode_id($sponsor):'')):'javascript:void(0);') ?>"> <i class="fa fa-star "></i> Sponsor&Current Employer <span class="label label-warning pull-right"><i class="fa <?php echo  ($sponsor ? 'fa-check':'fa-times'); ?> no-margins"></i></span> </a></li>
                                <?php
                            }
                            ?>
